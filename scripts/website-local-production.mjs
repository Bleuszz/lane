...
const child = spawn(process.execPath, ["scripts/start-server.mjs"], {
  ...
  env: {
    ...
    SCHEDULER_ENABLED: process.env.LANE_LOCAL_SCHEDULER_QA === "true" ? "true" : "false",
    IMAGE_NORMALIZATION_ENABLED: process.env.LANE_LOCAL_SCHEDULER_QA === "true" ? "true" : "false",
    BULK_AUTOMATION_ENABLED: "false",
    AI_PROVIDER: "mock",
