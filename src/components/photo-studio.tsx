...
export function PhotoStudio({ source, onSave, onClose }: { source: string; onSave: (url: string) => void; onClose: () => void }) {
  ...
  return <Modal label="Photo studio" onClose={onClose} className="w-[min(940px,95vw)] rounded-2xl border border-line bg-surface p-0 text-ink backdrop:bg-black/50">
